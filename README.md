...
Run the [Postman collection](https://www.postman.com/dsb/workspace/cdr-tests) with the environment file in **`src/postman/MiddleWare Demo.postman_environment.json`**, which contains an JWT access token with scopes.
